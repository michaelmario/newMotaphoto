                ...
                <div class="w3-col m3  w3-section">
                    <form id="filter-cat" class="js-filter-form" method="GET">
                        <select name="categories" id="categories-select"
                            ...
                            <option class="w3-margin" data-filter="<?php echo $termCategorie->slug; ?>">
                                <?php echo $termCategorie->name; ?></option>
                            <?php }                      
                                  ?>
                        </select>
                        <!-- </div> -->
                ...
                <div class="w3-col m3 w3-section">
                    <form id="filter-formats" method="GET">
                        <select name="format" id="filter-select"
                            ...
                            <option class="w3-margin" data-filter="<?php  echo $termFormat->slug; ?>">
                                <?php echo $termFormat->name; ?></option>
                            <?php }  ?>
                        </select>
                        <!-- </div> -->
                    </form>
        ...
        <div class="image-container">
            <div class="display-photo">
              ...
              $args = array(
               ...
               // je determine la limite d'affichage ici. Pour afficher tout : -1
                'paged' =>$page,
                );
               // my custom query
